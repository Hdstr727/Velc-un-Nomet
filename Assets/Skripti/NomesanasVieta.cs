            ...
            if (eventData.pointerDrag.tag.Equals(tag))
            {
                    ...
                    && (xIzmStarpiba <= 0.1 && yIzmStarpiba <= 0.1))
                {
                    ...
                    if (masinasPareizaVieta == 12)
                    {
                        ...
                        // Find the GameObject with the UzvarasAttelosana component
                        UzvarasAttelosana uzvarasAttelosana = FindObjectOfType<UzvarasAttelosana>();

                        if (uzvarasAttelosana != null)
                        {
                            // Call the method on the existing instance of UzvarasAttelosana
                            uzvarasAttelosana.AttelotUzvaru();
                        }
                        else
                        {
